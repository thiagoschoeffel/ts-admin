...
class ReasonPolicy
{
    ...
    public function viewAny(User $user): bool
    {
        ...
        return (bool)($permissions['reasons']['view'] ?? false);
    }
    ...
    public function create(User $user): bool
    {
        ...
        $permissions = $user->permissions ?? [];
        return (bool)($permissions['reasons']['create'] ?? false);
    }
    ...
    public function update(User $user, Reason $reason): bool
    {
        ...
        $permissions = $user->permissions ?? [];
        return (bool)($permissions['reasons']['update'] ?? false);
    }
    ...
    public function delete(User $user, Reason $reason): bool
    {
        ...
        $permissions = $user->permissions ?? [];
        return (bool)($permissions['reasons']['delete'] ?? false);
    }
