...
class OperatorPolicy
{
    ...
    public function viewAny(User $user): bool
    {
        ...
        return (bool)($permissions['operators']['view'] ?? false);
    }
    ...
    public function create(User $user): bool
    {
        ...
        $permissions = $user->permissions ?? [];
        return (bool)($permissions['operators']['create'] ?? false);
    }
    ...
    public function update(User $user, Operator $operator): bool
    {
        ...
        $permissions = $user->permissions ?? [];
        return (bool)($permissions['operators']['update'] ?? false);
    }
    ...
    public function delete(User $user, Operator $operator): bool
    {
        ...
        $permissions = $user->permissions ?? [];
        return (bool)($permissions['operators']['delete'] ?? false);
    }
