...
class UpdateAddressRequestTest extends TestCase
{
  ...
  public function test_authorize_returns_true_when_user_can_update_address()
  {
    $user = Mockery::mock(User::class);
    $client = Mockery::mock(Client::class);
    $user->shouldReceive('can')->with('updateAddress', $client)->andReturn(true);
  ...
  public function test_authorize_returns_false_when_user_cannot_update_address()
  {
    $user = Mockery::mock(User::class);
    $client = Mockery::mock(Client::class);
    $user->shouldReceive('can')->with('updateAddress', $client)->andReturn(false);
