...
class StoreAlmoxarifadoRequestTest extends TestCase
{
    use RefreshDatabase;
    ...
    public function test_admin_can_authorize_store_request()
    {
        ...
        $request = new StoreAlmoxarifadoRequest();
    ...
    public function test_validation_rules_require_unique_name()
    {
        ...
        $this->assertContains('unique:almoxarifados,name', $rules['name']);
    }
    ...
    {
        Almoxarifado::factory()->create(['name' => 'Setor Existente']);
        Auth::login($this->admin);
