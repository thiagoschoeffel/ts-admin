...
class UpdateAlmoxarifadoRequestTest extends TestCase
{
    use RefreshDatabase;
    ...
    public function test_admin_can_authorize_update_request()
    {
        ...
        $request = new UpdateAlmoxarifadoRequest();
    ...
    public function test_validation_rules_require_unique_name_ignoring_current_sector()
    {
        ...
        $this->assertStringContainsString('unique:almoxarifados,name', $rules['name']);
    ...
    {
        $otherAlmoxarifado = Almoxarifado::factory()->create(['name' => 'Outro Setor']);
        Auth::login($this->admin);
